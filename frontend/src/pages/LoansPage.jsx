...
function LoansPage({
  ...
  const emptyText =
    mode === "paid"
      ? "Здесь будут закрытые займы, отклоненные заявки и заявки с истекшим сроком."
      : "Здесь будут активные заявки и займы, которые еще не закрыты.";
